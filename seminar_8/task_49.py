...
def copy_data(file_name, file_name_2):
    if not exists(file_name_2):
        create_file(file_name_2)
    res = read_file(file_name)
    standart_write(file_name_2, res)
...
def main():
    while True:
        ...
        if command == "q":
            ...
            copy_data(file_name, file_name_2)
...
записать в новый файл используя функцию standart_write
